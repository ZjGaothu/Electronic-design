...
此外，我们修改了$LiquidCrystal\_I2C$库的内容，将其精简为我们可以使用的$serial\_lcd$库，其中的函数实现原理大致与官方库相同。此后该模块恰好能够利用该屏幕进行显示，因此我们考虑了一下多模块测量的显示方法，我们选用TTP226电容触摸开关进行显示内容的选择，不同的开关控制不同内容的显示，因此我们目前手头只有TTP224，并用其进行测试其触摸效果，结果十分令人满意。
...
\begin{diary}{}{2019.07.02下午}
\par{} 在下午我们继续对蓝牙模块进行调试，
