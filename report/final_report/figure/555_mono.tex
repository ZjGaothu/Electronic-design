...
-- (0.8,1.8) -- (0.8,1.5)
    to[/tikz/circuitikz/bipoles/length=0.7cm,C, a = $C$] (0.8,0) -- (0.8,0) node[ground]{};
...
% leftside terminal pins - 7 DIS, 6 THR, 2 TRG
    \draw (0.8,2.6) -- (1.83,2.6) node[right]{DIS} node[above left]{7}
        (0.8,2) |- (1.83,2) node[right]{THR} node[above left]{6}
        (0,1.2) -- (1.83,1.2) node[right]{TRG} node[above left]{2};
% rightside terminal pin - 3 out
    \draw (4.17,2) node[left]{Out} -- (4.8,2) node[above left]{3};
    \draw (0.8,2) to[short,*-](0.8,2); 
    \draw (0,1.2) to[short,o-](0,1.2) node[left]{$v_i$};
\end{tikzpicture}